...
export const siteContent: Record<Locale, SiteContent> = {
  en: {
    ...
    packages: {
      ...
      stdDescription: "Eidos Std is source-visible and independently versioned. It provides functional traits, Option, Result, right-biased Either, persistent and mutable containers, text and JSON, I/O, concurrency primitives, math, FFI, and runtime adapters.",
  ...
  "zh-CN": {
    ...
    packages: {
      ...
      manifest,
      stdTitle: "独立版本化的标准库",
      stdDescription: "Eidos Std 源码可见且独立版本化，提供函数式 trait、Option、Result、右偏 Either、持久化与可变容器、文本与 JSON、I/O、并发原语、数学、FFI 与运行时适配。",
